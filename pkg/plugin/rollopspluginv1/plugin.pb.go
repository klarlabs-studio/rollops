...
type GetManifestResponse struct {
	...
	Contracts     []*DeclaredContract    `protobuf:"bytes,6,rep,name=contracts,proto3" json:"contracts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetManifestResponse) GetContracts() []*DeclaredContract {
	if x != nil {
		return x.Contracts
	}
	return nil
...
// DeclaredContract names a typed service this plugin serves in addition to the
// generic Plugin service — e.g. kind "target", version 2 for
// rollops.target.v2.Target. It exists so that the handshake's protocol version
// stops doing double duty (ADR-0006): that number is about how the host and the
...
func (x *DeclaredContract) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeclaredContract) ProtoMessage() {}

func (x *DeclaredContract) ProtoReflect() protoreflect.Message {
	mi := &file_rollops_plugin_v1_plugin_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeclaredContract.ProtoReflect.Descriptor instead.
func (*DeclaredContract) Descriptor() ([]byte, []int) {
	return file_rollops_plugin_v1_plugin_proto_rawDescGZIP(), []int{2}
}

func (x *DeclaredContract) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *DeclaredContract) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *InvokeToolResponse) Reset() {
	*x = InvokeToolResponse{}
	mi := &file_rollops_plugin_v1_plugin_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InvokeToolResponse) Descriptor() ([]byte, []int) {
	return file_rollops_plugin_v1_plugin_proto_rawDescGZIP(), []int{7}
}
...
var file_rollops_plugin_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_rollops_plugin_v1_plugin_proto_goTypes = []any{
	...
	(*DeclaredContract)(nil),    // 2: rollops.plugin.v1.DeclaredContract
	(*Capability)(nil),          // 3: rollops.plugin.v1.Capability
	(*ToolDef)(nil),             // 4: rollops.plugin.v1.ToolDef
	(*SafetyRequirements)(nil),  // 5: rollops.plugin.v1.SafetyRequirements
	(*InvokeToolRequest)(nil),   // 6: rollops.plugin.v1.InvokeToolRequest
	(*InvokeToolResponse)(nil),  // 7: rollops.plugin.v1.InvokeToolResponse
}
var file_rollops_plugin_v1_plugin_proto_depIdxs = []int32{
	3, // 0: rollops.plugin.v1.GetManifestResponse.capabilities:type_name -> rollops.plugin.v1.Capability
	5, // 1: rollops.plugin.v1.GetManifestResponse.safety:type_name -> rollops.plugin.v1.SafetyRequirements
	2, // 2: rollops.plugin.v1.GetManifestResponse.contracts:type_name -> rollops.plugin.v1.DeclaredContract
	4, // 3: rollops.plugin.v1.Capability.tools:type_name -> rollops.plugin.v1.ToolDef
	0, // 4: rollops.plugin.v1.Plugin.GetManifest:input_type -> rollops.plugin.v1.GetManifestRequest
	6, // 5: rollops.plugin.v1.Plugin.InvokeTool:input_type -> rollops.plugin.v1.InvokeToolRequest
	1, // 6: rollops.plugin.v1.Plugin.GetManifest:output_type -> rollops.plugin.v1.GetManifestResponse
	7, // 7: rollops.plugin.v1.Plugin.InvokeTool:output_type -> rollops.plugin.v1.InvokeToolResponse
